...
RUN wget https://raw.githubusercontent.com/KeinShin/Black-Lightning/V2/amaansh1vamrun.py
RUN wget https://raw.githubusercontent.com/KeinShin/Black-Lightning/V2/requirements.txt
